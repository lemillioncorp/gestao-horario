...
<body>
 ...
 <div class="container">
    ...
    <form action="#" method="post" class="col-lg-4 col-lg-offset-4 my_form">
        <img src="assets/images/login/4.png" alt="" class="center-block">
            <h2 class="text-center">Acesso ao Sistema</h2>    
                
                    <label for="inputName" class="sr-only">Nome de Usuário</label>
                    <input type="text" name="nomeusuario" class="form-control" placeholder="Nome de Usuário" id="inputName" required autofocus>
                    ...
                    <input type="button" value="Entar" class="btn btn-primary btn-block login-btn" data-loading-text="Logando, Aguarde ...">
